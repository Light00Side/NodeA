...
#[derive(Debug)]
pub struct NodeAPIHubProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NodeAPIHubProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NodeAPIHub processing");
    
    let mut processor = NodeAPIHubProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NodeAPIHubProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NodeAPIHubProcessor::new(false);
